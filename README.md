...
- Для получения списка авторов с аффилиациями: **GET http://{домен}:{порт}/scopus/affilations/{doi}**
- Для получения списка авторов с полными данными аффилиаций: **GET http://{домен}:{порт}/scopus/full/affilations/{doi}**
